...
// JUMPjet: JumpjetHUD
// The Night Sortie design system: tokens, panels and instrument gauges.
//
...
let package = Package(
    ...
    products: [
        .library(name: "JumpjetHUD", targets: ["JumpjetHUD"])
    ],
    dependencies: [],
    targets: [
        .target(
        ...
        .testTarget(
            name: "JumpjetHUDTests",
            dependencies: ["JumpjetHUD"],
            swiftSettings: [.swiftLanguageMode(.v6)]
        ),
    ]
)
